...
As explained in [#221](https://github.com/lucasolslund/dnsx/issues/221), VPN operators sometimes filter high DNS/UDP traffic. To avoid packet loss you can tweak a few settings in the client app.
...
Happy hacking! s/o to Saber for letting me know about [#221](https://github.com/lucasolslund/dnsx/issues/221), helped me solve this problem & understand it. If this doesn't solve the problem, open an issue and tag me (@noctisatrae).